 ...
 <!-- Login Container -->
        <div id="login-container">
            ...
            <h1 class="h2 text-light text-center push-top-bottom animation-slideDown">
                <i class="fa fa-plus"></i> <strong>kimya-注&nbsp;&nbsp;册</strong>
            </h1>
            <!-- END Register Header -->
            ...
            <div class="block animation-fadeInQuickInv">
                ...
                <!-- Register Form -->
                <form id="form-register" action="userAction_register" method="post" class="form-horizontal">
                    <div class="form-group">
                        <div class="col-xs-12">
                            <input type="text" id="username" name="username" class="form-control" placeholder="用户名">
                        </div>
                    </div>
                    <div id="usernamemsg" class="help-block animation-slideUp" style="display:none;color:red;"></div>
                    
					<!--   下面是select元素 实验室选择 -->
                    <div class="col-md-5" id="labdiv">
						<select id="labid" name="labid" class="select-select2" style="width:100%;clear:both;" data-placeholder="请选择你所在实验室">
							<option value="">-------请选择你所在的实验室---------</option>
							<c:forEach var="lab" items="${allLab }">
						<option value="${lab.labid }">${lab.labname }</option>
					</c:forEach>
						</select>
					</div>
					<br><br>
					<div id="labmsg" class="help-block animation-slideUp" style="display:none;color:red;"></div>
<!--                     select元素实验室选择   完 -->
					
					<label>若列表中没有你所在的实验室请点击<a href="labAction_create">创建实验室</a></label>
					<div class="form-group">
                        <div class="col-xs-12">
...
<!--                     select元素实验室选择   完 -->
                    ...
                    <div class="form-group form-actions">
                        ...
                        <div class="col-xs-6 text-right">
                            <button type="submit" id="registersubmit" class="btn btn-effect-ripple btn-success"><i class="fa fa-plus"></i> 注册！</button>
                        </div>
                    </div>
                </form>
                <!-- END Register Form -->
        ...
        <script src="js/myjs/user/myregister.js"></script>
