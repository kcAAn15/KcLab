        ...
        <div id="page-wrapper" class="page-loading">
            ...
            <div id="page-container" class="header-fixed-top sidebar-visible-lg-full">
                        ...
                        <div class="sidebar-content">
                            ...
                            <ul class="sidebar-nav">
                                ...
                                <li class=" active">
                                    ...
                                    <ul>
                                        <li>
                                            <a href="reagentAction_list" class=" active">试剂列表</a>
                                        </li>
                                        <li>
                ...
                <div id="main-container">
                    ...
                    <form id="searchForm" action="reagentAction_search" method="post">
                            ...
                            <div id="tablediv" class="table-responsive">
									...
									<!--  	搜索开始 -->
                            			<label style="width:100%">
                            				<div id="searchdiv" class="input-group" ><input type="text" id="searchContent" name="searchContent" value="${pb.searchContent }" class="form-control" placeholder="查找试剂" aria-controls="example-datatable"><span class="input-group-addon"><a href="javascript:void(0)" id="mysearch"><i class="fa fa-search"></i></a></span></div>
                            				<div id="adddiv"  style="float: right;"><span class="input-group-addon"><a href="reagentAction_addReagentLoad"  style="text-decoration:none;"><i class="fa fa-search"></i><strong>添加试剂</strong></a></span></div>
                                ...
                                <table id="example-datatable" class="table table-striped table-bordered table-vcenter">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>试剂名</th>
                                            <th>存放地点</th>
                                            <th style="width: 120px;">是否有库存</th>
                                            <th class="text-center" style="width: 100px;">详情</th>
                                            <th class="text-center" style="width: 150px;">编辑&删除试剂</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    	<c:forEach var="reagent" items="${pb.dataList }" varStatus="status">
                                    		<tr>
                                    			<td class="text-center" style="">${ status.index + 1}</td>
                                    			<td style=""><strong>${reagent.reagentname }</strong></td>
                                    			<td style="">${reagent.location.locationname }</td>
                                    			<td style=""><span class="label label-info">
													<c:choose>
													   <c:when test="${reagent.isempty==0}">  
													         有库存     
													   </c:when>
													   <c:otherwise> 
														    无库存
													...
													<td class="text-center" >
														<a  href="#modal-terms" data-toggle="modal" title="查看详情" class="btn btn-effect-ripple btn-xs btn-success"><i id="detail${reagent.reagentid }" class="fa fa-pencil"></i></a>
													</td>
													<td class="text-center">
		                                                
		                                                <a href="reagentAction_editReagentLoad?reagentid=${reagent.reagentid }" data-toggle="tooltip" title="编辑试剂" class="btn btn-effect-ripple btn-xs btn-danger" onClick="return confirm('确定要编辑该试剂吗?');"><i  class="fa fa-pencil"></i></a>
		                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		                                                <a href="reagentAction_deleteReagent?reagentid=${reagent.reagentid }" data-toggle="tooltip" title="删除试剂" class="btn btn-effect-ripple btn-xs btn-danger" onClick="return confirm('确定删除该试剂吗?');"><i id="delet${reagent.reagentid }" class="fa fa-times"></i></a>
                                            		</td>
                                    		</tr>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div id="detaildiv" class="modal-body">
                                                    <h4 class="page-header">1. <strong>试剂名称</strong></h4>
                                                    <p id="P-reagentname"></p>
                                                    <h4 class="page-header">2. <strong>所在地点</strong></h4>
                                                    <p id="P-location"></p>
                                                    <h4 class="page-header">3. <strong>分子式</strong></h4>
                                                    <p id="P-mf"></p>
                                                    ...
                                                    <h4 class="page-header">8. <strong>试剂照片</strong></h4>
...
<!--         <script>$(function () {UiTables.init();});</script> -->
        <script src="js/myjs/reagent/myreagent.js"></script>
</body>
</html>