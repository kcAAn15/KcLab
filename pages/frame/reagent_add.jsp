                            ...
                            <ul class="sidebar-nav">
                                ...
                                <li class="active">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="reagentAction_addReagentLoad" class="active">添加试剂</a>
                                        </li>
                                    </ul>
                                </li>
                        ...
                        <div class="row">
                            <div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 col-lg-6 col-lg-offset-3">
                                ...
                                <div class="block">
                                    ...
                                    <form id="form-validation" action="reagentAction_addReagent" method="post" class="form-horizontal form-bordered" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" id="reagentname" name="reagentname" class="form-control" placeholder="请填写试剂中文名称">
                                            	<div id="reagentnamemsg" class="help-block animation-slideUp" style="display:none;color:red;"></div>
                                            </div>
                                        </div>
                                        
											<!-- 	试剂存放地点select 开始 -->
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="val-skill">试剂存放地点 <span class="text-danger">*</span></label>
                                            <div class="col-md-6">
                                                <select id="locationid" name="locationid" class="form-control">
                                                	
                                                    <option value="">请选择试剂存放地点</option>
                                                    <c:forEach var="location" items="${allLocation }">
														<option value="${location.locationid }">${location.locationname }</option>
													</c:forEach>
                                                </select>
                                                <br>
                                                <label >若没有所需存放的地点请点击<a href="locationAction_addLocationLoad">创建存放地点</a> </label>
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="val-username">试剂分子式 </label>
                                            <div class="col-md-6">
                                                <input type="text" id="mf" name="mf" class="form-control" placeholder="请填写试剂分子式">
                                            </div>
                                        </div>
                                        ...
                                        <!-- 	试剂购买人 结束 -->
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" id="date" name="date" class="form-control" placeholder="请填写试剂购买日期">
                                            </div>
                                        </div>
                                        
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="val-username">试剂规格 </label>
                                            <div class="col-md-6">
                                                <input type="text" id="specification" name="specification" class="form-control" placeholder="请填写试剂规格">
                                            </div>
                                        </div>
                                        
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="val-suggestions">试剂描述</label>
                                            <div class="col-md-9">
                                                <textarea id="description" name="description" rows="7" class="form-control" placeholder="请填写你认为需要的附加描述内容"></textarea>
                                            </div>
                                        </div>
                                        
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="val-username">试剂照片1</label>
                                            <div id="imgdiv1">
	                                            <div class="col-md-6" style="float:left">
	                                                <input type="file" id="img1" name="img1" class="form-control" placeholder="请添加试剂照片" accept="image/*" >
	                                            </div>
	                                            <div>
                                            ...
                                            <label class="col-md-3 control-label" for="val-username">试剂照片2</label>
	                                            <div id="imgdiv2">
		                                            <div class="col-md-6" style="float:left">
		                                                <input type="file" id="img2" name="img2" class="form-control" placeholder="请添加试剂照片" accept="image/*" >
		                                            </div>
		                                            <div>
                                            ...
                                            <label class="col-md-3 control-label" for="val-username">试剂照片3</label>
                                            <div id="imgdiv3">
	                                            <div class="col-md-6" style="float:left">
	                                                <input type="file" id="img3" name="img3" class="form-control" placeholder="请添加试剂照片" accept="image/*" >
	                                            </div>
	                                            <div>
                                            ...
                                            <label class="col-md-3 control-label" for="val-username">试剂照片4</label>
                                            <div id="imgdiv4">
	                                            <div class="col-md-6" style="float:left">
	                                                <input type="file" id="img4" name="img4" class="form-control" placeholder="请添加试剂照片" accept="image/*" >
	                                            </div>
	                                            <div>
                                            ...
                                            <label class="col-md-3 control-label" for="val-username">试剂照片5</label>
                                            <div id="imgdiv5">
	                                            <div class="col-md-6" style="float:left">
	                                                <input type="file" id="img5" name="img5" class="form-control" placeholder="请添加试剂照片" accept="image/*" >
	                                            </div>
	                                            <div>
...
<!--         <script>$(function () {UiTables.init();});</script> -->
        ...
        <script src="js/myjs/reagent/myreagentadd.js"></script>
</body>
</html>