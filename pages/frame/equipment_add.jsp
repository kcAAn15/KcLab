                        ...
                        <div class="row">
                            <div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 col-lg-6 col-lg-offset-3">
                                ...
                                <div class="block">
                                    ...
                                    <form id="form-validation" action="equipmentAction_addEquipment" method="post" class="form-horizontal form-bordered" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" id="equipmentname" name="equipmentname" class="form-control" placeholder="请填写设备名称...">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" id="model" name="model" class="form-control" placeholder="请填写设备型号">
                                            </div>
                                        </div>
                                        
                                        <!-- 	设备购买人 开始 -->
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="val-skill">设备购买人</label>
                                            <div class="col-md-6">
                                                <select id="purchaserid" name="purchaserid" class="form-control">
                                                	
                                                    <option value="">请选择设备购买人</option>
                                        ...
                                        <!-- 	设备购买人 结束 -->
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" id="date" name="date" class="form-control" placeholder="请填写设备购买日期">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" id="specification" name="specification" class="form-control" placeholder="请填写设备规格">
                                            </div>
                                        </div>
...
<!--         <script>$(function () {UiTables.init();});</script> -->
        ...
        <script src="js/myjs/equipment/myequipmentadd.js"></script>
</body>
</html>