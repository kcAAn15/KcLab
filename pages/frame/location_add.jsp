                        ...
                        <div class="row">
                            <div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 col-lg-6 col-lg-offset-3">
                                ...
                                <div class="block">
                                    ...
                                    <form id="form-validation" action="locationAction_addLocation" method="post" class="form-horizontal form-bordered" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" id="locationname" name="locationname" class="form-control" placeholder="请填写位置编号(如 东区01A)">
...
<!--         <script>$(function () {UiTables.init();});</script> -->
        ...
        <script src="js/myjs/location/mylocationadd.js"></script>
</body>
</html>