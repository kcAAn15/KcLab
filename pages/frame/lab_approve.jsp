                            ...
                            <ul class="sidebar-nav">
                                ...
                                <li class=" active">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="labAction_approveLabLoad" class=" active">实验室审核</a>
                                        </li>
                                    </ul>
                                </li>
									...
									<!--  	搜索开始 -->
                            			<label style="width:100%">
                            				<div id="searchdiv" class="input-group" ><input type="text" id="searchContent" name="searchContent" value="${pb.searchContent }" class="form-control" placeholder="查找实验室" aria-controls="example-datatable"><span class="input-group-addon"><a href="javascript:void(0)" id="mysearch"><i class="fa fa-search"></i></a></span></div>
                            					...
                            					<input type="hidden" id="approved" name="approve" value="no">
                            			</label>
                               		<!--  	搜索结束 -->
                                <table id="example-datatable" class="table table-striped table-bordered table-vcenter">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center" style="width: 150px;">通过&不通过</th>
                                        </tr>
                                    </thead>
                                    <tbody>
...
<%--                                     			<td style=""><strong>${lab.description }</strong></td> --%>
													...
													<td class="text-center">
		                                                ...
		                                                <a href="labAction_approveLab?approve=true&labid=${lab.labid }" data-toggle="tooltip" title="通过实验室审核" class="btn btn-effect-ripple btn-xs btn-danger" onClick="return confirm('确定要通过该实验室审核吗?');"><i  class="fa fa-pencil"></i></a>
		                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		                                                <a href="labAction_approveLab?approve=false&labid=${lab.labid }" data-toggle="tooltip" title="不通过实验室审核" class="btn btn-effect-ripple btn-xs btn-danger" onClick="return confirm('确定拒绝该实验室的审核吗?');"><i id="delet${lab.labid }" class="fa fa-times"></i></a>
                                            		</td>
