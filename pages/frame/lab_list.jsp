        ...
        <div id="page-wrapper" class="page-loading">
            ...
            <div id="page-container" class="header-fixed-top sidebar-visible-lg-full">
                        ...
                        <div class="sidebar-content">
                            ...
                            <ul class="sidebar-nav">
                                ...
                                <li class=" active">
                                    ...
                                    <ul>
                                        <li>
                                            <a href="labAction_list" class=" active">实验室列表</a>
                                        </li>
                                        <li>
                ...
                <div id="main-container">
                    ...
                    <form id="searchForm" action="labAction_search" method="post">
                            ...
                            <div id="tablediv" class="table-responsive">
									...
									<!--  	搜索开始 -->
                            			<label style="width:100%">
                            				<div id="searchdiv" class="input-group" ><input type="text" id="searchContent" name="searchContent" value="${pb.searchContent }" class="form-control" placeholder="查找实验室" aria-controls="example-datatable"><span class="input-group-addon"><a href="javascript:void(0)" id="mysearch"><i class="fa fa-search"></i></a></span></div>
                                ...
                                <table id="example-datatable" class="table table-striped table-bordered table-vcenter">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>实验室名称</th>
                                            <th style="width: 120px;">审核情况</th>
                                            <th class="text-center" style="width: 100px;">详情</th>
                                            <c:choose>
                        					<c:when test="${loginUser.groupid==0}">
                                            <th class="text-center" style="width: 150px;">编辑&删除实验室</th>
                        					</c:when>
                        					</c:choose>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    	<c:forEach var="lab" items="${pb.dataList }" varStatus="status">
                                    		<tr>
                                    			<td class="text-center" style="">${ status.index + 1}</td>
                                    			<td style=""><strong>${lab.labname }</strong></td>
<%--                                     			<td style=""><strong>${lab.description }</strong></td> --%>
                                    				<td style=""><span class="label label-info">
													<c:choose>
													   <c:when test="${lab.isapproved==0}">  
													         未审核     
													   </c:when>
													   <c:when test="${lab.isapproved==1}">  
													         审核通过     
													   </c:when>
													   <c:when test="${lab.isapproved==2}">  
													         未通过     
													   </c:when>
													</c:choose>
													</span></td>
													...
													<td class="text-center" >
														<a  href="#modal-terms" data-toggle="modal" title="查看详情" class="btn btn-effect-ripple btn-xs btn-success"><i id="detail${lab.labid }" class="fa fa-pencil"></i></a>
													</td>
													
			                        					
													<td class="text-center">
		                                                
		                                                <a href="labAction_editLabLoad_list?labid=${lab.labid }" data-toggle="tooltip" title="编辑实验室" class="btn btn-effect-ripple btn-xs btn-danger" onClick="return confirm('确定要编辑该实验室吗?');"><i  class="fa fa-pencil"></i></a>
		                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		                                                <a href="labAction_deleteLab?labid=${lab.labid }" data-toggle="tooltip" title="删除实验室" class="btn btn-effect-ripple btn-xs btn-danger" onClick="return confirm('确定删除该实验室吗?');"><i id="delet${lab.labid }" class="fa fa-times"></i></a>
                                            		</td>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div id="detaildiv" class="modal-body">
                                                    <h4 class="page-header">1. <strong>实验室名称</strong></h4>
                                                    <p id="P-labname"></p>
                                                    
                                                    <h4 class="page-header">2. <strong>实验室描述</strong></h4>
...
<!--         <script>$(function () {UiTables.init();});</script> -->
        <script src="js/myjs/lab/mylab.js"></script>
</body>
</html>