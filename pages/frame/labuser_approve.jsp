                            ...
                            <ul class="sidebar-nav">
                                ...
                                <li class=" active">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="userAction_checkUserLoad"  class=" active">成员审核</a>
                                        </li>
                                    </ul>
                                </li>
                                    		...
                                    		<tr>
                                    			...
                                    			<td style=""><span class="label label-info">
													...
													<td class="text-center">
		                                                ...
		                                                <a href="userAction_approveUser?approve=true&userid=${user.userid }" data-toggle="tooltip" title="通过审核" class="btn btn-effect-ripple btn-xs btn-danger" onClick="return confirm('确定要通过该成员审核吗?');"><i  class="fa fa-pencil"></i></a>
		                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		                                                <a href="userAction_approveUser?approve=false&userid=${user.userid }" data-toggle="tooltip" title="不通过审核" class="btn btn-effect-ripple btn-xs btn-danger" onClick="return confirm('确定不通过该成员审核吗?');"><i id="delet${user.userid }" class="fa fa-times"></i></a>
                                            		</td>
			                        					</c:when>
		                        					</c:choose>
                                    		</tr>
