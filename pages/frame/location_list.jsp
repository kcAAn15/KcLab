        ...
        <div id="page-wrapper" class="page-loading">
            ...
            <div id="page-container" class="header-fixed-top sidebar-visible-lg-full">
                        ...
                        <div class="sidebar-content">
                            ...
                            <ul class="sidebar-nav">
                                ...
                                <li class=" active">
                                    ...
                                    <ul>
                                        <li>
                                            <a href="locationAction_list" class=" active">区域列表</a>
                                        </li>
                                        <li>
                ...
                <div id="main-container">
                    ...
                    <form id="searchForm" action="locationAction_search" method="post">
                            ...
                            <div id="tablediv" class="table-responsive">
									...
									<!--  	搜索开始 -->
                            			<label style="width:100%">
                            				<div id="searchdiv" class="input-group" ><input type="text" id="searchContent" name="searchContent" value="${pb.searchContent }" class="form-control" placeholder="查找存储位置" aria-controls="example-datatable"><span class="input-group-addon"><a href="javascript:void(0)" id="mysearch"><i class="fa fa-search"></i></a></span></div>
                            				<div id="adddiv"  style="float: right;"><span class="input-group-addon"><a href="locationAction_addLocationLoad"  style="text-decoration:none;"><i class="fa fa-search"></i><strong>添加储存位置</strong></a></span></div>
                                ...
                                <table id="example-datatable" class="table table-striped table-bordered table-vcenter">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center" style="width: 150px;">编辑&删除位置</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    	<c:forEach var="location" items="${pb.dataList }" varStatus="status">
                                    		<tr>
                                    			<td class="text-center" style="">${ status.index + 1}</td>
                                    			<td style=""><strong>${location.locationname }</strong></td>
                                    		
                                    			
													<td class="text-center" >
														<a  href="#modal-terms" data-toggle="modal" title="查看详情" class="btn btn-effect-ripple btn-xs btn-success"><i id="detail${location.locationid }" class="fa fa-pencil"></i></a>
													</td>
													<td class="text-center">
		                                                
		                                                <a href="locationAction_editLocationLoad?locationid=${location.locationid }" data-toggle="tooltip" title="编辑位置" class="btn btn-effect-ripple btn-xs btn-danger" onClick="return confirm('确定要编辑该位置吗?');"><i  class="fa fa-pencil"></i></a>
		                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		                                                <a href="locationAction_deleteLocation?locationid=${location.locationid }" data-toggle="tooltip" title="删除位置" class="btn btn-effect-ripple btn-xs btn-danger" onClick="return confirm('确定删除该位置吗?');"><i id="delet${location.locationid }" class="fa fa-times"></i></a>
                                            		</td>
                                    		</tr>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div id="detaildiv" class="modal-body">
                                                    <h4 class="page-header">1. <strong>存储位置名称</strong></h4>
                                                    <p id="P-locationname"></p>
                                                    <h4 class="page-header">2. <strong>该位置描述</strong></h4>
...
<!--         <script>$(function () {UiTables.init();});</script> -->
        <script src="js/myjs/location/mylocation.js"></script>
</body>
</html>