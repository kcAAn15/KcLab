                            ...
                            <div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 col-lg-6 col-lg-offset-3">
                                ...
                                <div class="block">
                                    ...
                                    <form id="form-validation" action="" method="post" class="form-horizontal form-bordered" enctype="multipart/form-data">
                                        ...
                                        <input type="hidden" name="reagentid" id="reagentid" value="${reagent.reagentid }">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" id="reagentname" name="reagentname" class="form-control" placeholder="请填写试剂中文名称" value="${reagent.reagentname }">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" id="mf" name="mf" class="form-control" placeholder="请填写试剂分子式" value="${reagent.mf }">
                                            </div>
                                        </div>
                                        ...
                                        <!-- 	试剂购买人 结束 -->
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" id="date" name="date" class="form-control" placeholder="请填写试剂购买日期" value="${reagent.date }">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" id="specification" name="specification" class="form-control" placeholder="请填写试剂规格" value="${reagent.specification }">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <textarea id="description" name="description" rows="7" class="form-control" placeholder="请填写你认为需要的附加描述内容">${reagent.description }</textarea>
                                            </div>
                                        </div>
...
<!--         <script>$(function () {UiTables.init();});</script> -->
        ...
        <script src="js/myjs/reagent/myreagentedit.js"></script>
</body>
</html>