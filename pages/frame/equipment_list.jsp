        ...
        <div id="page-wrapper" class="page-loading">
            ...
            <div id="page-container" class="header-fixed-top sidebar-visible-lg-full">
                        ...
                        <div class="sidebar-content">
                            ...
                            <ul class="sidebar-nav">
                                ...
                                <li class="active">
                                    ...
                                    <ul>
                                        <li>
                                            <a href="equipmentAction_list" class="active">设备列表</a>
                                        </li>
                                        <li>
                ...
                <div id="main-container">
                    ...
                    <form id="searchForm" action="equipmentAction_search" method="post">
                            ...
                            <div id="tablediv" class="table-responsive">
									...
									<!--  	搜索开始 -->
                            			<label style="width:100%">
                            				<div id="searchdiv" class="input-group" ><input type="text" id="searchContent" name="searchContent" value="${pb.searchContent }" class="form-control" placeholder="查找设备" aria-controls="example-datatable"><span class="input-group-addon"><a href="javascript:void(0)" id="mysearch"><i class="fa fa-search"></i></a></span></div>
                            				<div id="adddiv"  style="float: right;"><span class="input-group-addon"><a href="equipmentAction_addEquipmentLoad"  style="text-decoration:none;"><i class="fa fa-search"></i><strong>添加设备</strong></a></span></div>
                                ...
                                <table id="example-datatable" class="table table-striped table-bordered table-vcenter">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center" style="width: 150px;">编辑&删除设备</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    	<c:forEach var="equipment" items="${pb.dataList }" varStatus="status">
                                    		<tr>
                                    			<td class="text-center" style="">${ status.index + 1}</td>
                                    			<td style=""><strong>${equipment.equipmentname }</strong></td>
                                    			<td style="">${equipment.location.locationname }</td>
                                    			<td style=""><span class="label label-info">
													<c:choose>
													   <c:when test="${equipment.isbroken==0}">  
													         功能完好     
													   </c:when>
													   <c:otherwise> 
														    损坏
													...
													<td class="text-center" >
														<a  href="#modal-terms" data-toggle="modal" title="查看详情" class="btn btn-effect-ripple btn-xs btn-success"><i id="detail${equipment.equipmentid }" class="fa fa-pencil"></i></a>
													</td>
													<td class="text-center">
		                                                
		                                                <a href="equipmentAction_editEquipmentLoad?equipmentid=${equipment.equipmentid }" data-toggle="tooltip" title="编辑设备" class="btn btn-effect-ripple btn-xs btn-danger" onClick="return confirm('确定要编辑该设备吗?');"><i  class="fa fa-pencil"></i></a>
		                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		                                                <a href="equipmentAction_deleteEquipment?equipmentid=${equipment.equipmentid }" data-toggle="tooltip" title="删除设备" class="btn btn-effect-ripple btn-xs btn-danger" onClick="return confirm('确定删除该设备吗?');"><i id="delet${equipment.equipmentid }" class="fa fa-times"></i></a>
                                            		</td>
                                    		</tr>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div id="detaildiv" class="modal-body">
                                                    <h4 class="page-header">1. <strong>设备名称</strong></h4>
                                                    <p id="P-equipmentname"></p>
                                                    <h4 class="page-header">2. <strong>所在地点</strong></h4>
                                                    <p id="P-location"></p>
                                                    <h4 class="page-header">3. <strong>设备型号</strong></h4>
                                                    <p id="P-model"></p>
                                                    <h4 class="page-header">4. <strong>购买人</strong></h4>
                                                    <p id="P-purchaser"></p>
                                                    <h4 class="page-header">5. <strong>购买日期</strong></h4>
                                                    <p id="P-date"></p>
                                                    <h4 class="page-header">6. <strong>规格</strong></h4>
                                                    <p id="P-specification"></p>
                                                    <h4 class="page-header">7. <strong>描述</strong></h4>
                                                    <p id="P-description"></p>
                                                    <h4 class="page-header">8. <strong>设备照片</strong></h4>
...
<!--         <script>$(function () {UiTables.init();});</script> -->
        <script src="js/myjs/equipment/myequipment.js"></script>
</body>
</html>