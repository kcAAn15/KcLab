                            ...
                            <ul class="sidebar-nav">
                                ...
                                <li  class="active">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="labAction_addLabLoad"  class="active">添加实验室</a>
                                        </li>
                                        <li>
                                ...
                                <div class="block">
                                    ...
                                    <form id="form-validation" action="" method="post" class="form-horizontal form-bordered" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="val-username">实验室名称 <span class="text-danger">*</span></label>
                                            <div class="col-md-6">
                                                <input type="text" id="labname" name="labname" class="form-control" placeholder="请填写实验室名称(如 有机楼2XX)">
                                            	<div id="labnamemsg" class="help-block animation-slideUp" style="display:none;color:red;"></div>
                                            </div>
                                        </div>
...
<!--         <script>$(function () {UiTables.init();});</script> -->
        ...
        <script src="js/myjs/lab/mylabadd.js"></script>
</body>
</html>