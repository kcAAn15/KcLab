                            ...
                            <ul class="sidebar-nav">
                                ...
                                <li class="active">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="locationAction_addLocationLoad"  class="active">添加区域</a>
                                        </li>
                                    </ul>
                                </li>
                        ...
                        <div class="row">
                            <div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 col-lg-6 col-lg-offset-3">
                                ...
                                <div class="block">
                                    ...
                                    <form id="form-validation" action="locationAction_editLocation" method="post" class="form-horizontal form-bordered" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="val-username">位置名称 <span class="text-danger">*</span></label>
                                            <div class="col-md-6">
                                                <input type="text" id="locationname" name="locationname" class="form-control" placeholder="请填写位置编号(如 东区01A)" value="${location.locationname }">
                                            	<div id="locationnamemsg" class="help-block animation-slideUp" style="display:none;color:red;"></div>
                                            </div>
                                        </div>
                                        
										
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="val-suggestions">位置描述</label>
                                            <div class="col-md-9">
                                                <textarea id="description" name="description" rows="7" class="form-control" placeholder="请填写你认为需要的附加描述内容">${location.description }</textarea>
                                            </div>
                                        </div>
...
<!--         <script>$(function () {UiTables.init();});</script> -->
        ...
        <script src="js/myjs/location/mylocationedit.js"></script>
</body>
</html>